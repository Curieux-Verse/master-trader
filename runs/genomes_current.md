...
*Generated 2026-08-13 21:16 UTC · source `/home/runner/work/master-trader/master-trader/var/mt.db`*

## 1 · Executive summary

| | |
|---|---|
| Genomes generated & tested | **132,723** |
| Deflated-Sharpe trial count (raw N) | **351,321** *(evals 132,723 + 218,598 screened)* |
| **Effective** independent trials (N_eff) | **279,434** *(ρ̄=0.06223716162749882 — the bar the DSR actually uses)* |
| Admitted to archive | **11758** |
| Rejected | **120,965** (91.1%) |
| Distinct families explored | **31** |
| Lessons accumulated | **102,826** |
...
|---|---:|---:|---|
| `—` | 88,015 | 66.3% | — |
| `GS_screen` | 17,725 | 13.4% | — |
| `ADMITTED` | 11,758 | 8.9% | **cleared every gate** |
| `G1_sanity` | 7,678 | 5.8% | degenerate / too few periods, or one period dominates P&L |
| `G3_cpcv_pbo` | 3,622 | 2.7% | parameter tuning overfit (high PBO) |
| `G0_eval` | 1,897 | 1.4% | did not produce a valid backtest |
| `G9_plateau` | 1,471 | 1.1% | — |
| `G8_orthogonality` | 287 | 0.2% | duplicates an existing archive member |
| `G5_robustness` | 221 | 0.2% | bootstrap tail drawdown too large |
| `G2_oos` | 49 | 0.0% | shines in-sample, decays out-of-sample |
...
|---|---:|---:|---:|---|
| `cross_sectional` | 101108 | 4794 | 1.50 | ████████████████·· |
| `directional` | 31615 | 6964 | 0.76 | ████████·········· |
...
|---|---:|---:|---:|---|
| `evo` | 115082 | 11739 | 1.50 | ████████████████·· |
| `llm` | 4430 | 11 | 1.35 | ███████████████··· |
| `template` | 3172 | 0 | 0.31 | ███··············· |
| `random` | 2910 | 0 | -0.67 | ·················· |
| `miner` | 7129 | 8 | -1.00 | ·················· |
...
|---|---:|---:|---:|---|
| `all` | 78948 | 4215 | 1.50 | ████████████████·· |
| `low_vol` | 39609 | 7248 | 0.83 | █████████········· |
| `chop` | 4004 | 45 | 0.22 | ██················ |
| `trend` | 5646 | 206 | 0.02 | ·················· |
| `high_vol` | 4516 | 44 | -0.37 | ·················· |
...
|---|---:|---:|---:|---|
| `rank_bucket` | 103576 | 6050 | 1.50 | ████████████████·· |
| `kelly_fraction` | 711 | 10 | 0.85 | █████████········· |
| `fixed_fractional` | 26045 | 5697 | 0.76 | ████████·········· |
| `vol_target` | 1497 | 1 | -1.05 | ·················· |
...
|---|---:|---:|---:|---|
| `microstructure` | 21165 | 2611 | 1.50 | ████████████████·· |
| `liquidity` | 20691 | 2602 | 1.50 | ████████████████·· |
| `macro` | 21431 | 2224 | 1.38 | ███████████████··· |
| `regime` | 12942 | 1652 | 1.38 | ███████████████··· |
| `rates` | 8237 | 844 | 1.38 | ███████████████··· |
| `momentum` | 18711 | 2089 | 0.86 | █████████········· |
| `trend` | 16332 | 1686 | 0.86 | █████████········· |
| `auction_market_theory` | 16396 | 1898 | 0.85 | █████████········· |
| `market_profile` | 13377 | 1591 | 0.85 | █████████········· |
| `statistical` | 22141 | 5576 | 0.83 | █████████········· |
| `pattern` | 3600 | 305 | 0.83 | █████████········· |
| `breakout` | 3488 | 305 | 0.83 | █████████········· |
| `volatility` | 18866 | 4315 | 0.76 | ████████·········· |
| `mean_reversion` | 15611 | 4835 | 0.76 | ████████·········· |
| `ict` | 6179 | 1505 | 0.75 | ████████·········· |
| `smc` | 6179 | 1505 | 0.75 | ████████·········· |
| `positioning` | 16091 | 1702 | 0.60 | ███████··········· |
| `ml_derived` | 9721 | 1370 | 0.60 | ███████··········· |
| `order_flow` | 1650 | 165 | 0.55 | ██████············ |
| `cross_asset` | 1240 | 184 | 0.53 | ██████············ |
| `intermarket` | 1183 | 184 | 0.53 | ██████············ |
| `oscillator` | 2854 | 130 | 0.40 | ████·············· |
| `event` | 2365 | 209 | 0.12 | █················· |
| `volume` | 3616 | 367 | 0.03 | ·················· |
| `mixed` | 59081 | 1249 | -0.11 | ·················· |
| `volume_profile` | 1224 | 110 | -0.16 | ·················· |
| `crypto` | 2474 | 252 | -0.30 | ·················· |
| `funding` | 2474 | 252 | -0.30 | ·················· |
| `persistence` | 613 | 25 | -0.51 | ·················· |
| `calendar` | 14 | 0 | -1.69 | ·················· |
| `sentiment` | 6 | 0 | -17.94 | ·················· |
...
| `intx_f626c78a` | 8 | +2.458 | **carries signal** |
| `intx_72d5925f` | 2 | +2.390 | **carries signal** |
| `intx_16f6ebcd` | 2 | +2.267 | **carries signal** |
| `intx_025b0355` | 849 | +2.184 | **carries signal** |
| `intx_896c4ec5` | 1365 | +2.035 | **carries signal** |
...
- ×6 — [G9_plateau] amihud_illiquidity+auction_market_theory+consolidation_score+hurst+interaction+intx_137ddd7b+intx_421762f1+int
...
- ×4 — [GS_screen] interaction+intx_a3066de6+mined+obv (cross_sectional) — raw predictive strength too weak to clear the FDR scre
- ×4 — [PASS] breakout+pattern on a cross_sectional book promoted to the candidate pool
- ×4 — [PASS] breakout+interaction+intx_06f14519+intx_0f5c18ca+intx_3d05d214+intx_525eb3f5+intx_678cc793+intx_e927eded+mined
- ×4 — [GS_screen] auction_market_theory+volume (cross_sectional) — raw predictive strength too weak to clear the FDR screen [p_s
- ×3 — [G9_plateau] amihud_illiquidity+auction_market_theory+consolidation_score+interaction+intx_137ddd7b+intx_2f8a5346+intx_4217
...
- ×3 — [GS_screen] har_vol+interaction+intx_10e814d4+intx_13e60945+intx_19456efa+intx_2f41065c+intx_8d20bcb1+intx_8eae474d+intx_9
