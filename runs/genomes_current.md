...
*Generated 2026-09-21 07:16 UTC · source `/home/runner/work/master-trader/master-trader/var/mt.db`*

## 1 · Executive summary

| | |
|---|---|
| Genomes generated & tested | **137,841** |
| Deflated-Sharpe trial count (raw N) | **510,820** *(evals 137,841 + 372,979 screened)* |
| **Effective** independent trials (N_eff) | **585,788** *(ρ̄=0.013613049494423468 — the bar the DSR actually uses)* |
| Admitted to archive | **12056** |
| Rejected | **125,785** (91.3%) |
| Distinct families explored | **31** |
| Lessons accumulated | **169,949** |
...
|---|---:|---:|---|
| `—` | 88,587 | 64.3% | — |
| `GS_screen` | 19,159 | 13.9% | — |
| `ADMITTED` | 12,056 | 8.7% | **cleared every gate** |
| `G1_sanity` | 7,989 | 5.8% | degenerate / too few periods, or one period dominates P&L |
| `G3_cpcv_pbo` | 3,785 | 2.7% | parameter tuning overfit (high PBO) |
| `G0_eval` | 3,689 | 2.7% | did not produce a valid backtest |
| `G9_plateau` | 1,890 | 1.4% | — |
| `G5_robustness` | 354 | 0.3% | bootstrap tail drawdown too large |
| `G8_orthogonality` | 316 | 0.2% | duplicates an existing archive member |
...
|---|---:|---:|---:|---|
| `cross_sectional` | 102737 | 5389 | 1.50 | ████████████████·· |
| `directional` | 35104 | 6667 | 0.76 | ████████·········· |
...
|---|---:|---:|---:|---|
| `evo` | 102170 | 12035 | 1.50 | ████████████████·· |
| `llm` | 6463 | 12 | 1.35 | ███████████████··· |
| `template` | 4819 | 0 | 0.31 | ███··············· |
| `random` | 13277 | 3 | -0.67 | ·················· |
| `miner` | 11112 | 6 | -1.00 | ·················· |
...
|---|---:|---:|---:|---|
| `all` | 66548 | 4264 | 1.50 | ████████████████·· |
| `low_vol` | 41308 | 7023 | 0.83 | █████████········· |
| `chop` | 15389 | 633 | 0.22 | ██················ |
| `trend` | 7336 | 99 | 0.02 | ·················· |
| `high_vol` | 7260 | 37 | -0.37 | ·················· |
...
|---|---:|---:|---:|---|
| `rank_bucket` | 97096 | 6594 | 1.50 | ████████████████·· |
| `kelly_fraction` | 3544 | 9 | 0.85 | █████████········· |
| `fixed_fractional` | 27618 | 5447 | 0.76 | ████████·········· |
| `vol_target` | 6084 | 2 | -1.05 | ·················· |
| `atr_scaled` | 3499 | 4 | -2.73 | ·················· |
...
|---|---:|---:|---:|---|
| `microstructure` | 8105 | 2279 | 1.50 | ████████████████·· |
| `liquidity` | 7754 | 2270 | 1.50 | ████████████████·· |
| `macro` | 17379 | 1935 | 1.38 | ███████████████··· |
| `regime` | 4076 | 1436 | 1.38 | ███████████████··· |
| `rates` | 2598 | 760 | 1.38 | ███████████████··· |
| `momentum` | 15772 | 2575 | 0.86 | █████████········· |
| `trend` | 12099 | 1903 | 0.86 | █████████········· |
| `auction_market_theory` | 5534 | 1578 | 0.85 | █████████········· |
| `market_profile` | 4021 | 1385 | 0.85 | █████████········· |
| `statistical` | 20110 | 5278 | 0.83 | █████████········· |
| `pattern` | 10025 | 886 | 0.83 | █████████········· |
| `breakout` | 9997 | 886 | 0.83 | █████████········· |
| `mean_reversion` | 15479 | 4682 | 0.76 | ████████·········· |
| `volatility` | 14216 | 3644 | 0.76 | ████████·········· |
| `ict` | 5376 | 1390 | 0.75 | ████████·········· |
| `smc` | 5376 | 1390 | 0.75 | ████████·········· |
| `positioning` | 15499 | 1468 | 0.60 | ███████··········· |
| `ml_derived` | 2655 | 1167 | 0.60 | ███████··········· |
| `order_flow` | 1004 | 118 | 0.55 | ██████············ |
| `cross_asset` | 430 | 168 | 0.53 | ██████············ |
| `intermarket` | 406 | 168 | 0.53 | ██████············ |
| `oscillator` | 10555 | 922 | 0.40 | ████·············· |
| `event` | 435 | 182 | 0.12 | █················· |
| `volume` | 2119 | 233 | 0.03 | ·················· |
| `mixed` | 68863 | 1253 | -0.11 | ·················· |
| `volume_profile` | 874 | 82 | -0.16 | ·················· |
| `crypto` | 714 | 218 | -0.30 | ·················· |
| `funding` | 714 | 218 | -0.30 | ·················· |
| `persistence` | 565 | 30 | -0.51 | ·················· |
| `calendar` | 18 | 0 | -1.69 | ·················· |
| `sentiment` | 6 | 0 | -5.91 | ·················· |
...
| `intx_5191f1a1` | 16 | +9.270 | **carries signal** |
| `intx_d77b40a2` | 3 | +8.415 | **carries signal** |
| `intx_44967b18` | 40 | +8.274 | **carries signal** |
| `intx_f1aba59e` | 17 | +8.189 | **carries signal** |
| `intx_b9823837` | 76 | +8.122 | **carries signal** |
| `intx_3215531f` | 5 | +8.097 | **carries signal** |
| `intx_c0948539` | 28 | +8.094 | **carries signal** |
| `intx_4d3d5099` | 13 | +8.026 | **carries signal** |
| `intx_76be7af0` | 39 | +7.573 | **carries signal** |
...
## 6 · Lessons library (169,949)

- ×9 — [GS_screen] interaction+intx_107a686b+intx_14305a58+intx_1f414506+intx_42055f3a+intx_60559019+intx_a6796742+intx_cf206cbd+
- ×7 — [GS_screen] interaction+intx_0c7bda3f+intx_107a686b+intx_14539bcd+intx_e379cdeb+mined+momentum+oscillator (cross_sectional
- ×6 — [GS_screen] adx+ict+interaction+intx_a16b7695+intx_ab31bc67+intx_f27ad431+liquidity+microstructure+mined+ml_derived+moment
- ×6 — [GS_screen] interaction+intx_01d36f0b+intx_191a2c8c+intx_218ac4c2+intx_24e4fbb9+intx_48cd464a+intx_549c5216+intx_5519b55d+
- ×6 — [PASS] interaction+intx_05645eba+intx_4f4b182d+mined on a directional book promoted to the candidate pool
- ×5 — [GS_screen] breakout+interaction+intx_011edeee+intx_0507d207+intx_05645eba+intx_06f14519+intx_12692236+intx_2f8a0ced+intx_
- ×3 — [PASS] interaction+intx_3086ff7a+intx_753ea6e7+intx_8e0d4062+intx_fe341f6e+mean_reversion+mined+statistical+volatilit
- ×3 — [GS_screen] cumulative_delta+interaction+intx_4e7895a8+intx_59dc96bb+intx_c441a7af+mined (cross_sectional) — raw predictiv
- ×3 — [PASS] interaction+intx_aa7e61a2+intx_b44526ed+mined+oscillator on a cross_sectional book promoted to the candidate p
- ×3 — [GS_screen] interaction+intx_aa7e61a2+intx_b44526ed+mined+oscillator (cross_sectional) — raw predictive strength too weak 
...
- ×3 — [GS_screen] interaction+intx_3d1eba7a+intx_f3c3558f+mined (cross_sectional) — raw predictive strength too weak to clear th
- ×2 — [GS_screen] mean_reversion+statistical (directional) — raw predictive strength too weak to clear the FDR screen [p_single=
- ×2 — [GS_screen] interaction+intx_0c7bda3f+intx_107a686b+intx_14539bcd+intx_e379cdeb+mined (cross_sectional) — raw predictive s
- ×2 — [G1_sanity] interaction+intx_0418bb01+intx_4e7895a8+intx_59dc96bb+intx_852601b5+intx_b3efd92e+intx_d5dddd91+mined (cross_s
