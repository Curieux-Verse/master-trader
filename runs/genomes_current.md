...
*Generated 2026-08-29 04:27 UTC · source `/home/runner/work/master-trader/master-trader/var/mt.db`*

## 1 · Executive summary

| | |
|---|---|
| Genomes generated & tested | **135,189** |
| Deflated-Sharpe trial count (raw N) | **401,072** *(evals 135,189 + 265,883 screened)* |
| **Effective** independent trials (N_eff) | **353,028** *(ρ̄=0.029066432624757645 — the bar the DSR actually uses)* |
| Admitted to archive | **12884** |
| Rejected | **122,305** (90.5%) |
| Distinct families explored | **31** |
| Lessons accumulated | **125,732** |
...
|---|---:|---:|---|
| `—` | 91,186 | 67.5% | — |
| `GS_screen` | 15,087 | 11.2% | — |
| `ADMITTED` | 12,884 | 9.5% | **cleared every gate** |
| `G1_sanity` | 7,868 | 5.8% | degenerate / too few periods, or one period dominates P&L |
| `G3_cpcv_pbo` | 3,582 | 2.6% | parameter tuning overfit (high PBO) |
| `G0_eval` | 1,954 | 1.4% | did not produce a valid backtest |
| `G9_plateau` | 1,761 | 1.3% | — |
| `G2_oos` | 395 | 0.3% | shines in-sample, decays out-of-sample |
...
|---|---:|---:|---:|---|
| `cross_sectional` | 104375 | 6061 | 1.50 | ████████████████·· |
| `directional` | 30814 | 6823 | 0.76 | ████████·········· |
...
|---|---:|---:|---:|---|
| `evo` | 115866 | 12867 | 1.50 | ████████████████·· |
| `llm` | 3350 | 11 | 1.35 | ███████████████··· |
| `template` | 3682 | 0 | 0.31 | ███··············· |
| `random` | 3454 | 0 | -0.67 | ·················· |
| `miner` | 8837 | 6 | -1.00 | ·················· |
...
|---|---:|---:|---:|---|
| `all` | 80185 | 4362 | 1.50 | ████████████████·· |
| `low_vol` | 38092 | 7139 | 0.83 | █████████········· |
| `chop` | 8504 | 1193 | 0.22 | ██················ |
| `trend` | 4743 | 137 | 0.02 | ·················· |
| `high_vol` | 3665 | 53 | -0.37 | ·················· |
...
|---|---:|---:|---:|---|
| `rank_bucket` | 106092 | 7357 | 1.50 | ████████████████·· |
| `kelly_fraction` | 783 | 9 | 0.85 | █████████········· |
| `fixed_fractional` | 26434 | 5517 | 0.76 | ████████·········· |
...
|---|---:|---:|---:|---|
| `microstructure` | 17135 | 2359 | 1.50 | ████████████████·· |
| `liquidity` | 16724 | 2346 | 1.50 | ████████████████·· |
| `macro` | 19521 | 2111 | 1.38 | ███████████████··· |
| `regime` | 10606 | 1496 | 1.38 | ███████████████··· |
| `rates` | 7211 | 802 | 1.38 | ███████████████··· |
| `trend` | 17707 | 2682 | 0.86 | █████████········· |
| `momentum` | 15771 | 1868 | 0.86 | █████████········· |
| `auction_market_theory` | 13846 | 1651 | 0.85 | █████████········· |
| `market_profile` | 11228 | 1437 | 0.85 | █████████········· |
| `statistical` | 22644 | 5448 | 0.83 | █████████········· |
| `pattern` | 9465 | 1926 | 0.83 | █████████········· |
| `breakout` | 9380 | 1926 | 0.83 | █████████········· |
| `volatility` | 18717 | 4296 | 0.76 | ████████·········· |
| `mean_reversion` | 15792 | 4727 | 0.76 | ████████·········· |
| `ict` | 5711 | 1471 | 0.75 | ████████·········· |
| `smc` | 5711 | 1471 | 0.75 | ████████·········· |
| `positioning` | 15014 | 1625 | 0.60 | ███████··········· |
| `ml_derived` | 7936 | 1217 | 0.60 | ███████··········· |
| `order_flow` | 1121 | 136 | 0.55 | ██████············ |
| `cross_asset` | 1008 | 171 | 0.53 | ██████············ |
| `intermarket` | 962 | 171 | 0.53 | ██████············ |
| `oscillator` | 3219 | 140 | 0.40 | ████·············· |
| `event` | 2205 | 188 | 0.12 | █················· |
| `volume` | 3403 | 267 | 0.03 | ·················· |
| `mixed` | 61160 | 1218 | -0.11 | ·················· |
| `volume_profile` | 896 | 86 | -0.16 | ·················· |
| `crypto` | 1932 | 226 | -0.30 | ·················· |
| `funding` | 1932 | 226 | -0.30 | ·················· |
...
| `intx_8934b6e2` | 12 | +3.137 | **carries signal** |
| `intx_b1e4646b` | 38 | +3.014 | **carries signal** |
| `intx_107bc3cf` | 37 | +2.726 | **carries signal** |
...
## 6 · Lessons library (125,732)

- ×18 — [PASS] breakout+interaction+intx_011edeee+intx_0507d207+intx_05645eba+intx_06f14519+intx_12692236+intx_2f8a0ced+intx_
- ×13 — [PASS] cci+interaction+intx_080bbe39+intx_10e814d4+intx_39165f4d+intx_4f97afa7+intx_56f51694+intx_6ff832ad+intx_743ce
...
- ×5 — [PASS] cci+interaction+intx_10e814d4+intx_39165f4d+intx_48be30c6+intx_4f97afa7+intx_56f51694+intx_743ce137+intx_cf267
- ×4 — [GS_screen] cumulative_delta+interaction+intx_0fe63907+intx_10e814d4+intx_336dfc1f+intx_4d789e45+macro+mined+poc_distance_
- ×4 — [PASS] breakout+interaction+intx_011edeee+intx_0507d207+intx_12692236+intx_5fdddd9f+intx_64624138+intx_8699d1d2+intx_
- ×4 — [GS_screen] amihud_illiquidity+interaction+intx_10e814d4+intx_39165f4d+intx_4f97afa7+intx_58001d43+intx_6a4a9e33+intx_7045
...
- ×3 — [GS_screen] cci+interaction+intx_080bbe39+intx_10e814d4+intx_39165f4d+intx_4f97afa7+intx_56f51694+intx_6ff832ad+intx_743ce
- ×3 — [PASS] adx+candlestick_pattern+interaction+intx_3086ff7a+intx_753ea6e7+intx_79ab66d9+intx_c1763857+mean_reversion+min
